...
const DomesticVisitor = ({ navigation, route }) => {
    ...
    const submitVisiterData = () => {
        ...
        if (visitorMobileNo === '' || visitorMobileNo.trim().length < 10 || !validatePhoneNum(visitorMobileNo)) {
            ...
            navigation.navigate('Domestic Visitor Navigation', { screen: 'QuestionScreen1', params: { visitorName, optionSelected, visitorMobileNo } });
        }
    }

    console.log('optionSelected--->', optionSelected);
    console.log('visitorMobileNo--->', visitorMobileNo);
