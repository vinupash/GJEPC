...
const MySurveys = ({ navigation, route }) => {
    ...
    // const searchUserData = (item) => {
    //     console.log('This is selected value --->', selectedFilter, moment(selectedFromDate).format("DD-MMM-YYYY"), moment(selectedToDate).format("DD-MMM-YYYY"));
    // }

    const getFilteredData = () => {
        // console.log('This is selected value --->', selectedFilter, moment(selectedFromDate).format("DD-MMM-YYYY"), moment(selectedToDate).format("DD-MMM-YYYY"));
        console.log('surveyList--->', surveyList);
        const filteredData = surveyList.filter((item) => item.question_1 === selectedFilter);
        setFlatListItems(filteredData);
        console.log('filteredData--->', filteredData);
        // input.filter((item)=>item.type===''shrikant')
    }
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <SelectDropdown
                data={domestics}
                ref={dropdownRef}
                onSelect={(selectedItem, index, reset) => {
            ...
            {!flatListItems ? <Text>No record found!</Text> : (
                <FlatList
            ...
            {/* {flatListItems === null ? <Text>Cool</Text> : <Text>Cool 2</Text>} */}
